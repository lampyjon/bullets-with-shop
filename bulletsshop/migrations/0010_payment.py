# Generated by Django 2.1.1 on 2018-09-27 23:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bulletsshop', '0009_basketitem_quantity'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='bulletsshop.Order')),
            ],
            options={
                'abstract': False,
            },
